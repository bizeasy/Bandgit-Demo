    ...
    <div id="masthead">
      <ul>
        ...
        <#else>
          ...
          <#if headerImageUrl??>
                <#if organizationLogoLinkURL?has_content>
                    <li><a href="<@ofbizUrl>/images/heathrow_logo.jpg</@ofbizUrl>"><img alt="${layoutSettings.companyName}" src="<@ofbizContentUrl>${StringUtil.wrapString(organizationLogoLinkURL)}</@ofbizContentUrl>"></a></li>
                    <#else>
                    <li class="logo-area"><a href="<@ofbizUrl>/images/heathrow_logo.jpg</@ofbizUrl>"><img alt="${layoutSettings.companyName}" src="<@ofbizContentUrl>${StringUtil.wrapString(headerImageUrl)}</@ofbizContentUrl>"/></a></li>
                </#if>
          </#if>
